...
/**
 * @title Wrapper around the Rules Engine Run Logic for testing internal functionality of the Rules Engine 
 * @author @mpetersoCode55 
 */
contract RulesEngineLogicWrapper is RulesEngineRunLogic {
