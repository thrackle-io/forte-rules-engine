 ...
 */
contract ExampleERC20WithDenyListFlex is ExampleERC20 {
    ...
    function transfer(
        ...
        bool isOnDenyListFrom = fc.onTheNaughtyList(msg.sender);
        if (isOnDenyList || isOnDenyListFrom) {
            revert("To or From Address is denied");
        } 
