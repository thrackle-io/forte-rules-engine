...
abstract contract rulesEngineInternalFunctions is RulesEngineCommon {
        ...
        endWithStopPrank
    {
        ...
        RulesEngineProcessorFacet(address(red)).evaluateForeignCallForRule(fc, vals, retVals, typeSpecificIndices);
        assertEq(foreignCall.getDecodedIntOne(), 1);
    }

    function testRulesEngine_Unit_EncodingForeignCallUintWithRetVals()
        public
        ifDeploymentTestsEnabled
        endWithStopPrank
    {
    ...
    function testRulesEngine_Unit_EncodingForeignCallTwoUintWithRetVals()
        public
        ifDeploymentTestsEnabled
        endWithStopPrank
    {
    ...
    function testRulesEngine_Unit_EncodingForeignCallAddressWithRetVals()
        public
        ifDeploymentTestsEnabled
        endWithStopPrank
    {
    ...
    function testRulesEngine_Unit_EncodingForeignCallTwoAddrWithRetVals()
        public
        ifDeploymentTestsEnabled
        endWithStopPrank
    {
    ...
    function testRulesEngine_Unit_EncodingForeignCallStringWithRetVals()
        public
        ifDeploymentTestsEnabled
        endWithStopPrank
    {
    ...
    function testRulesEngine_Unit_EncodingForeignCallTwoStringWithRetVals()
        public
        ifDeploymentTestsEnabled
        endWithStopPrank
    {
    ...
    function testRulesEngine_Unit_EncodingForeignCallArrayUintWithRetVals()
        public
        ifDeploymentTestsEnabled
        endWithStopPrank
    {
    ...
    function testRulesEngine_Unit_EncodingForeignCallTwoArrayUintWithRetVals()
        public
        ifDeploymentTestsEnabled
        endWithStopPrank
    {
    ...
    function testRulesEngine_Unit_EncodingForeignCallTwoArrayStringWithRetVals()
        public
        ifDeploymentTestsEnabled
        endWithStopPrank
    {
        ...
        endWithStopPrank
    {
        ...
        RulesEngineProcessorFacet(address(red))
            .evaluateForeignCallForRule(fc, vals, retVals, typeSpecificIndices);
